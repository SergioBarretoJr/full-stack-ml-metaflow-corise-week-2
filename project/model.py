...
class NbowModel():
    def __init__(self, vocab_sz, l1=1e-5, l2=1e-4, dropout=0.1,learning_rate=0.002, epoch = 10):
        ...
        x = layers.Dense(
            15, activation="relu",
            kernel_regularizer=regularizers.L1L2(l1=self.l1, l2=self.l2)
        )(x)
    ...
    def fit(self, X, y):
        ...
        self.model.fit(x=res, y=y, batch_size=32, 
                       epochs=self.epoch, validation_split=.2)
